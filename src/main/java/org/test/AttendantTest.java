...
public class AttendantTest {
    ...
    public static ParkingSpace mockedSpace;
    ...
    public void testParkSuccess() throws Exception {
        ...
        List<ParkingLot> plotList = new ArrayList<ParkingLot>();
    ...
    public void setUp() {
        ...
        mockedSpace = mock(ParkingSpace.class);
        ...
        when(mockedSpace.getPlList()).thenReturn(plotList);
        when(mockedSpace.getAvailablePLSize()).thenReturn(plotList.size());
    }
    ...
    @Test(expected = ParkingSpaceFullException.class)
    public void testMaxCapacityPLFailure() {
        Attendant attendant = new Attendant(mockedSpace);
